...
<div id="tabs-1">
	...
	<div style="background: whitesmoke; ">
		<div style="padding-top: 15px; width:250px; float: left;">
					<div id="InfoDesk" style = "overflow: hidden;width: 100%;">
						<c:if test="${!empty smVo }">
							<img id="tier" style = "float: left; width:120%; height:auto; " alt="<%=lgVo.getTier()%>" 
								src="<%=request.getContextPath() %>/images/tier/<%=lgVo.getTier().toLowerCase()%>.png"/>
						</c:if>
						<c:if test="${empty smVo }">
