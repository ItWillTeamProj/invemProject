...
public class AdminMemberDTO {
	...
	public AdminMemberDTO(String userid, String nickname, String pwd, String name, String dateofbirth, String phoneno,
	...
	public String toString() {
		return "AdminMemberDTO [userid=" + userid + ", nickname=" + nickname + ", pwd=" + pwd + ", name=" + name
